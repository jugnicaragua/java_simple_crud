[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=jugnicaragua_java_simple_crud&metric=alert_status)](https://sonarcloud.io/dashboard?id=jugnicaragua_java_simple_crud)
